...
## `keypoint-moseq` motivation {.smaller}

- Classical depth moseq methods
- Fails on keypoints because of jitter
- Sources of jitter: pose estimation errors
- Smoothing doesn't always help (blurs the boundaries)

## Hierarchical modeling of behaviour {.smaller}
- Switching linear dynamical systems (SLDS)
  - explicitly disentangle signal from noise in time-series data
- Has 3 levels of hierarchy
  - low-level: kinematics
  - mid-level: syllables
  - high-level: behaviours

## `keypoint-moseq` drawbacks {.smaller}
- probabilistic output (ensemble of models)
